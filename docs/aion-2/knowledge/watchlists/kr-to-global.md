...
- server transfers
- прозрачен map overlay
- Character Switch
- pet auto-loot
- допълнителна gear, Arcana и accessory прогресия
- нови dungeon, expedition и transcendence активности
- healing rework за Cleric и Chanter
- cross-faction matchmaking в част от съдържанието
- AMD FSR 4 и NVIDIA DLSS промени в KR клиента
